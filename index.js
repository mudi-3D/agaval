...
class MudiExperience {
            ...
            <div class="containerBtnsActions">
                ...
                <div id="containerQR" class="containerQRMudi" style="background-color:${this.color}">
                    ...
                    <div class="containerText">
                        ...
                        <div class="titleContainer">
                            <div class="iconTitle">
                                <img class="stepMudi step1" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/agaval@latest/assets/step3.webp">
                            </div>
                        ...
                        <div class="titleContainer">
                            <div class="iconTitle">
                                <img class="stepMudi step2" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/agaval@latest/assets/step4.webp">
                            </div>
                        ...
                        <div class="titleContainer">
                            <div class="iconTitle">
                                <img class="stepMudi step3" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/agaval@latest/assets/step2.webp">
                            </div>
                        ...
                        <div class="titleContainer">
                            <div class="iconTitle">
                                <img class="stepMudi step4" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/agaval@latest/assets/step1.webp">
                            </div>
    ...
    mudiRequest(skuNumber) {
        ...
        let container = document.querySelector('.vtex-store-components-3-x-triggerContainer.vtex-store-components-3-x-triggerContainer--pdp.bg-transparent.pa0.bw0.dib');
        if (container) {
